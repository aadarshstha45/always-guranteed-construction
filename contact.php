        ...
        <div
            ...
            <div class="flex flex-col gap-4  min-[1060px]:border-r-[4px] min-[1060px]:border-r-primary-500">
                ...
                <?php foreach ($contacts as $index => $item) : ?>
                    <div class="flex items-start gap-4">
                        <div class="relative flex justify-center items-center min-w-[37px] min-h-[37px] rounded-[5px]  bg-gradient-to-b from-[#168BFF] to-[#167ADD]">
                            <?= $item['icon'] ?>
                        </div>
            ...
            flex flex-col gap-4 px-[20px] min-[400px]:px-[48px] pb-[50px] w-full h-full">
                <form class="grid grid-cols-1 min-[570px]:grid-cols-2 gap-6" id="contactForm">
                    ...
                    <input type="text" name="address" class="input-text col-span-2 min-[570px]:col-span-1" placeholder="Address: " required />
                    <textarea name="message" class="input-text col-span-2 min-h-[110px]" placeholder="Message: " required></textarea>
                    <button type="submit" class="rounded-md bg-gradient-to-b from-[#168BFF] to-[#167ADD] text-white h-[40px] col-span-2 hover:from-[#167ADD] hover:to-[#168BFF] active:scale-[0.98] active:brightness-90 transition-all">
                        Send now
                    </button>
